...
class Particle(pygame.sprite.Sprite):
    ...
    def add_particles(self, particle_x, particle_y):
        # add particles
        particle_x = particle_x + 30
        particle_y = particle_y + 120
        radius = 5.5
        direction_y = 1.25  # -1, particle go upwards
        direction_x = random.uniform(-0.7, 0.7)
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        for num in range(1, 6):
            img = pygame.image.load(f"Images/Extras/exp{num}.png")
