    ...
    while carryOn:
        ...
        """ 
          QUESTIONS FOR LIAH:
                ...
                Powerup code structure good?
                
            1º - Centrar corpo de size changed player car
            ...
            2º - Permitir usar só 2 power ups ao mm tempo --> criar variável que conta os powerups apanhados --> 
                 ...
                 Não deixar outro power ups aparecer enquanto tamos a usar 1 powerup e já temos outro
                 
                  
            4º - if playerCar collides with car ... any powerup activated ends

        
            5.(-2)º - ARRANJAR PROBLEMA CARROS PISACREM QUANDO N DEVEM
        ...
        if all(not powerup.active for powerup in incoming_powerups_list):
            ...
            # 30%
            elif 20 <= spawn_prob <= 40:
                power_up_jet_bomb.active = True
            # 15%
            elif 40 <= spawn_prob < 60:
            ...
            # 15%
            elif 60 <= spawn_prob < 80:
                power_up_size_change.active = True
            # 10%
            elif 80 <= spawn_prob <= 100:
        ...
        # Powerup Features:
        """
        Ver se ponho effects na função visual_effect
        
        Problem: Writting effect code in affect_player/affect_traffic function, 
        makes it only last a milisecond...because powerup loop
        """
