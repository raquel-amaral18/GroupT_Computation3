...
"""
Rocket (meter musica de fundo do pac man com cereja enquanto powerup ativo)
"""


class Rocket(PowerUp):  # Fire icon
    def __init__(self, icon_path, width, initial_x):
        super().__init__(icon_path, width, initial_x)
        self.rect.y = random.randint(-2000, -1000)
        self.active = False
